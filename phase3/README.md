...
1. **[RULES.md](RULES.md)** - thể lệ đầy đủ: cấu trúc TF, nền Well-Architected (Security / Reliability / Performance Efficiency / Cost Optimization / Auditability) + Lens AI, timeline 3 tuần, và **luật chơi** (đọc kỹ mục luật - có điều khoản disqualify).
